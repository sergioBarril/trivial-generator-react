...
function MainButton({ iconUrl, label }: MainButtonProps) {
  return (
    <div className="flex flex-col w-full items-center justify-center bg-grey-lighter mx-5">
      <label className="w-64 flex flex-col items-center px-4 py-7 bg-white text-gray-500 rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:text-teal-800">
