...
function MainButton({ iconUrl, label, onClick }: MainButtonProps) {
  return (
    <div
      onClick={onClick}
      className="flex flex-col w-full items-center justify-center bg-grey-lighter mx-5  transition-filter duration-300 hover:drop-shadow-[0_0_1.2em_#6988e6aa]"
    >
